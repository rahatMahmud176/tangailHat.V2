<nav class="navbar navbar-expand navbar-light navbar-bg" style="background: #40B866;">
...
<i class="hamburger align-self-center"></i>
            ...
            <li class="nav-item dropdown">
                <a class="nav-icon dropdown-toggle" href="#" id="alertsDropdown" data-bs-toggle="dropdown">
                    <div class="position-relative">
                        ...
                        <span class="indicator text-warning">4</span>
                    </div>
                </a>
    ...
    <img src="{{ asset('/backEnd') }}/img/profile.png" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-white">{{ Session::get('adminName') }}</span>
  </a>
