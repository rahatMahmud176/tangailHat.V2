...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle"><img src="{{ asset('/backEnd/img') }}/TangailHat.V2.Logo.png" width="170px" alt=""></span>
        </a>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{ asset('/backEnd') }}/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">{{ Session::get('adminName') }}</span>
              </a>
