            ...
            <div class="owl-carousel owl-theme events navs-carousel" id="team-carousel">
                <div class="item">
                    <div class="card text-center team-box">
                        <div class="card-body">
                            <div>
                                <img src="{{ asset('/') }}frontEnd/assets/images/users/avatar-2.jpg"
                                    alt="" class="rounded">
                            </div>
                ...
                <div class="item">
                    <div class="card text-center team-box">
                        <div class="card-body">
                            <div>
                                <img src="{{ asset('/') }}frontEnd/assets/images/users/avatar-8.jpg"
                                    alt="" class="rounded">
                            </div>
                            <div class="mt-3">
                                <h5>Vickie Sample</h5>
                ...
                <div class="item">
                    <div class="card text-center team-box">
                        <div class="card-body">
                            <div>
                                <img src="{{ asset('/') }}frontEnd/assets/images/users/avatar-5.jpg"
                                    alt="" class="rounded">
                            </div>
                ...
                <div class="item">
                    <div class="card text-center team-box">
                        <div class="card-body">
                            <div>
                                <img src="{{ asset('/') }}frontEnd/assets/images/users/avatar-1.jpg"
                                    alt="" class="rounded">
                            </div>
