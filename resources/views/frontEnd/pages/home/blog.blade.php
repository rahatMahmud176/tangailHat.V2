        ...
        <div class="row">
            <div class="col-xl-4 col-sm-6">
                <div class="blog-box mb-4 mb-xl-0">
                    <div class="position-relative">
                        <img src="{{ asset('/') }}frontEnd/assets/images/crypto/blog/img-1.jpg" alt=""
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="blog-box mb-4 mb-xl-0">
                    ...
                    <div class="position-relative">
                        <img src="{{ asset('/') }}frontEnd/assets/images/crypto/blog/img-2.jpg" alt=""
                            class="rounded img-fluid mx-auto d-block">
                        <div class="badge badge-success blog-badge font-size-11">Cryptocurrency</div>
                    </div>
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="blog-box mb-4 mb-xl-0">
                    <div class="position-relative">
                        <img src="{{ asset('/') }}frontEnd/assets/images/crypto/blog/img-3.jpg" alt=""
                            class="rounded img-fluid mx-auto d-block">
                        <div class="badge badge-success blog-badge font-size-11">Cryptocurrency</div>
                    </div>
